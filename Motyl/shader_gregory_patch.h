...
////////////////////////////////////////////////////////////////////////////////
// Class name: BwzierPatchShader
////////////////////////////////////////////////////////////////////////////////
class GregoryPatchShader : public ShaderBase
{

public:

	GregoryPatchShader();
	GregoryPatchShader(std::shared_ptr<ID3D11DeviceContext>,
		gk2::DeviceHelper m_device,
		D3D11_PRIMITIVE_TOPOLOGY topology);
	GregoryPatchShader(const GregoryPatchShader&);
	~GregoryPatchShader();
