...
const std::wstring SimplePointShader::ShaderFile = RESOURCES_PATH L"shaders/SimplePoint.hlsl";


void* SimplePointShader::operator new(size_t size)
{
	return Utils::New16Aligned(size);
}

void SimplePointShader::operator delete(void* ptr)
{
	Utils::Delete16Aligned(ptr);
}

SimplePointShader::SimplePointShader(std::shared_ptr<ID3D11DeviceContext> context,
...
SimplePointShader::SimplePointShader(const SimplePointShader&)
{
}

std::shared_ptr<ID3D11Buffer>& SimplePointShader::GetCBColor()
{
	return m_color;
}


void SimplePointShader::InitializeConstantBuffers()
{
...
void SimplePointShader::InitializeShaders()
{
...
void SimplePointShader::SetConstantBuffers()
{
