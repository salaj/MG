...
////////////////////////////////////////////////////////////////////////////////
class IntersectionSquareShader : public ShaderBase
{

public:

	IntersectionSquareShader();
	IntersectionSquareShader(std::shared_ptr<ID3D11DeviceContext>,
		gk2::DeviceHelper m_device,
		D3D11_PRIMITIVE_TOPOLOGY topology);
	IntersectionSquareShader(const IntersectionSquareShader&);
	~IntersectionSquareShader();
