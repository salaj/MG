...
////////////////////////////////////////////////////////////////////////////////
class IntersectionSurfaceShader : public ShaderBase
{

public:

	IntersectionSurfaceShader();
	IntersectionSurfaceShader(std::shared_ptr<ID3D11DeviceContext>,
		gk2::DeviceHelper m_device,
		D3D11_PRIMITIVE_TOPOLOGY topology);
	IntersectionSurfaceShader(const IntersectionSurfaceShader&);
	~IntersectionSurfaceShader();
